...
// инициализация
let myImageSlider = new Swiper(".main-slider__body", {
  navigation: {
...
let sliderLotsBody = new Swiper(".slider-lots__body", {
  navigation: {
    nextEl: ".control-sliders-lots__arrow_next",
    prevEl: ".control-sliders-lots__arrow_prev",
  },
  observer: true,
  observerParent: true,
  loop: true,
...
let sliderQuotesBody = new Swiper(".slider-quotes__body", {
  navigation: {
